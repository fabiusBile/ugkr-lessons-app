...
static const MonoBundledAssembly assembly_bundle_Mono_Android_dll = {"Mono.Android.dll", assembly_data_Mono_Android_dll, 15056896};
extern const unsigned char assembly_data_mscorlib_dll [];
static const MonoBundledAssembly assembly_bundle_mscorlib_dll = {"mscorlib.dll", assembly_data_mscorlib_dll, 2884608};
extern const unsigned char assembly_data_System_Xml_dll [];
static const MonoBundledAssembly assembly_bundle_System_Xml_dll = {"System.Xml.dll", assembly_data_System_Xml_dll, 1272320};
extern const unsigned char assembly_data_System_dll [];
static const MonoBundledAssembly assembly_bundle_System_dll = {"System.dll", assembly_data_System_dll, 1203712};
extern const unsigned char assembly_data_Mono_Security_dll [];
static const MonoBundledAssembly assembly_bundle_Mono_Security_dll = {"Mono.Security.dll", assembly_data_Mono_Security_dll, 300032};
extern const unsigned char assembly_data_System_Core_dll [];
static const MonoBundledAssembly assembly_bundle_System_Core_dll = {"System.Core.dll", assembly_data_System_Core_dll, 706560};
